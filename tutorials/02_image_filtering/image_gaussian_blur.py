...
cv.imwrite('../../image/noisy_women_gaussian_blurred.png', gaussian_blur_women)
cv.imwrite('../../image/noisy_women_gaussian_blurred_sigmas_1.png', gaussian_blur_women_g1)
cv.imwrite('../../image/noisy_rat_gaussian_blurred.png', gaussian_blur_rat)