...
cv.imwrite('../../image/hand_gaussian_blur_and_sobel_x_edge_detection.jpg',sobelx_gaussian)
cv.imwrite('../../image/hand_gaussian_blur_and_sobel_y_edge_detection.jpg',sobely_gaussian)
cv.imwrite('../../image/hand_gaussian_blur_and_sobel_xy_edge_detection.jpg',sobelxy_gaussian)

cv.imwrite('../../image/hand_median_blur_and_sobel_x_edge_detection.jpg',sobelx_median)
cv.imwrite('../../image/hand_median_blur_and_sobel_y_edge_detection.jpg',sobely_median)
cv.imwrite('../../image/hand_median_blur_and_sobel_xy_edge_detection.jpg',sobelxy_median)